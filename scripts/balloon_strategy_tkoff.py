...
class BalloonStrategy(object):
    ...
    def arm_and_takeoff(self , aTargetAltitude ):
        ...
        if self.vehicle.mode.name == "GUIDED":
            if not self.controlling_vehicle:
                ...
                while not self.vehicle.location.global_relative_frame.alt>=self.aTargetAltitude*0.95:
    ...
    def analyze_image(self):
        ...
        # look for balloon in image using blob detecto
        if self.use_OpenMV:
    ...
    def start_search(self):
        ...
        print  "Vehicle status" , self.search_state
